...
plt.savefig(r'Figures\figureS4.svg', format='svg', bbox_inches='tight')
plt.savefig(r'Figures\figureS4.eps', format='eps', bbox_inches='tight')
plt.show()
...
output_path = os.path.join('Results', 'monthly_article_means_fig1a.xlsx')
monthly_means.to_excel(output_path, index=False)

output_path = os.path.join('Results', 'daily_article_means_quota_fig1b.xlsx')
...
plt.tight_layout()  
plt.savefig(r'Figures\figureS5.svg', format='svg', bbox_inches='tight')
plt.savefig(r'Figures\figureS5.eps', format='svg', bbox_inches='tight')
plt.show()

# Save results
figs5 = pd.DataFrame({'Days': days, 'Daily shares': means})

daily_means_advice = pd.DataFrame({'Days': days, 'Daily shares': means})

output_path = os.path.join('Results', 'daily_article_means_advice_figS5.xlsx')
daily_means_quota.to_excel(output_path, index=False)
...
plt.minorticks_off()
plt.tight_layout()
plt.savefig(r'Figures\figureS6.svg', format='svg', bbox_inches='tight')
plt.savefig(r'Figures\figureS6.eps', format='svg', bbox_inches='tight')
plt.show()
...
output_path = os.path.join('Results', 'fish_shares_figS6.xlsx')
